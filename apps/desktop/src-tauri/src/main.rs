...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::categorias_fsr::list_categorias_fsr,
            commands::categorias_fsr::create_categoria_fsr,
            commands::categorias_fsr::update_categoria_fsr,
            commands::categorias_fsr::delete_categoria_fsr,
