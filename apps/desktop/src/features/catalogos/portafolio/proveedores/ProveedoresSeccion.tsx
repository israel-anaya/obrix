...
import { ProveedorFormPanel } from "@/features/catalogos/portafolio/proveedores/ProveedorFormPanel";
...
const PROVEEDORES: CatalogoGeneralDescriptor<Proveedor, ProveedorData> = {
  ...
  api: {
    ...
    create: api.createProveedor,
    update: api.updateProveedor,
    remove: api.deleteProveedor,
  },
  aFila: (m) => ({
    _id: m.id,
