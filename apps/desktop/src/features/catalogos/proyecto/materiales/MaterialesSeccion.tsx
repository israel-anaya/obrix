...
import { adaptadorCostosLote } from "@/features/catalogos/proyecto/materiales/csv/adaptadorCostosLote";
import { adaptadorExportMateriales, adaptadorImportMateriales } from "@/features/catalogos/proyecto/materiales/csv/adaptadorMateriales";
import { MaterialFormPanel } from "@/features/catalogos/proyecto/materiales/MaterialFormPanel";
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <CsvOperationDialog
        ...
        onDone={() => void refrescarMateriales()}
      />
    </div>
  );
}
