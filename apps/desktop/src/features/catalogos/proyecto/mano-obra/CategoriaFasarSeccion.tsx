...
import { CategoriaFasarFormPanel } from "@/features/catalogos/proyecto/mano-obra/CategoriaFasarFormPanel";
import { adaptadorExportCategoriasFasar, adaptadorImportCategoriasFasar } from "@/features/catalogos/proyecto/mano-obra/csv/adaptadorCategoriasFasar";
import { adaptadorSalariosLote } from "@/features/catalogos/proyecto/mano-obra/csv/adaptadorSalariosLote";
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <CsvOperationDialog
        ...
        onDone={() => void refrescarCategorias()}
      />
    </div>
  );
}
