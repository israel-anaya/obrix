...
import type { CsvCatalogField } from "@/components/csv/catalogCsvAdapter";

export interface CatalogoGeneralDescriptor<T extends { id: string }, Nuevo> {
  id: string;
  titulo: string;
  grid: DataGridConfig;
  api: CatalogGeneralApi<T, Nuevo>;
  aFila: (modelo: T) => Row;
...
const organizaciones: CatalogoGeneralDescriptor<Organizacion, OrganizacionData> = {
  ...
  api: {
    ...
    create: api.createOrganizacion,
    update: api.updateOrganizacion,
    remove: api.deleteOrganizacion,
  },
...
const unidadesMedida: CatalogoGeneralDescriptor<UnidadMedida, UnidadMedidaData> = {
  ...
  api: {
    ...
    create: api.createUnidadMedida,
    update: api.updateUnidadMedida,
    remove: api.deleteUnidadMedida,
  },
  aFila: (m) => ({
    _id: m.id,
    simbolo: m.simbolo,
...
const regiones: CatalogoGeneralDescriptor<Region, RegionData> = {
  ...
  api: {
    ...
    create: api.createRegion,
    update: api.updateRegion,
    remove: api.deleteRegion,
  },
  aFila: (m) => ({
    _id: m.id,
    nombre: m.nombre,
...
const familiasInsumo: CatalogoGeneralDescriptor<FamiliaInsumo, FamiliaInsumoData> = {
  ...
  api: {
    ...
    create: api.createFamiliaInsumo,
    update: api.updateFamiliaInsumo,
    remove: api.deleteFamiliaInsumo,
  },
...
const monedas: CatalogoGeneralDescriptor<Moneda, MonedaData> = {
  ...
  api: {
    ...
    create: api.createMoneda,
    update: api.updateMoneda,
    remove: api.deleteMoneda,
  },
  aFila: (m) => ({
    _id: m.id,
    codigo: m.codigo,
